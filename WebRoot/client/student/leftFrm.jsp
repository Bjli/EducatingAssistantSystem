...
$(function(){	
  ...
  <body style="background:#f0f9fd;">
    ...
    <ul class="menuson">
        <li><cite></cite><a href="${pageContext.request.contextPath}/servlet/GradeServlet?operation=sCheckGrade&studentID=${sessionScope.userID}" target="middleFrame">查看成绩</a><i></i></li>
        </ul>     
    </dd>      
